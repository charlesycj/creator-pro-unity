...
public class ObjectUpbuff : MonoBehaviour
{
    [SerializeField]
    private GameObject buffPrefabUp;        // 버프 아이템 프리팹
    ...
    public void SpawnBuff()
    {
        ...
        // 버프 생성
        GameObject buff = Instantiate(buffPrefabUp, spawnPosition, Quaternion.identity);
